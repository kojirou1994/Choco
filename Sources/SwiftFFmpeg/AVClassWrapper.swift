...
//internal typealias AVClass = CFFmpeg.AVClass
...
public final class AVClassWrapper {
    internal let clazzPtr: UnsafePointer<AVClass>
    internal var clazz: AVClass { return clazzPtr.pointee }

    internal init(clazzPtr: UnsafePointer<AVClass>) {
...
extension AVFormatContextWrapper {
    ...
    public var avClass: AVClassWrapper {
        return AVClassWrapper(clazzPtr: avformat_get_class())
    }
}
...
extension AVCodecContext {
    ...
    public var avClass: AVClassWrapper {
        return AVClassWrapper(clazzPtr: avcodec_get_class())
    }
}
