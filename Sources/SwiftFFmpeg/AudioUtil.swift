...
public struct AVChannelLayout: Equatable, CustomStringConvertible {
    ...
    public static let CHL_NATIVE = AVChannelLayout(rawValue: AV_CH_LAYOUT_NATIVE)
    public static let CHL_MONO = AVChannelLayout(rawValue: AV_CH_LAYOUT_MONO)
    public static let CHL_STEREO = AVChannelLayout(rawValue: AV_CH_LAYOUT_STEREO)
    public static let CHL_2POINT1 = AVChannelLayout(rawValue: AV_CH_LAYOUT_2POINT1)
    public static let CHL_2_1 = AVChannelLayout(rawValue: AV_CH_LAYOUT_2_1)
    public static let CHL_SURROUND = AVChannelLayout(rawValue: AV_CH_LAYOUT_SURROUND)
    public static let CHL_3POINT1 = AVChannelLayout(rawValue: AV_CH_LAYOUT_3POINT1)
    public static let CHL_4POINT0 = AVChannelLayout(rawValue: AV_CH_LAYOUT_4POINT0)
    public static let CHL_4POINT1 = AVChannelLayout(rawValue: AV_CH_LAYOUT_4POINT1)
    public static let CHL_2_2 = AVChannelLayout(rawValue: AV_CH_LAYOUT_2_2)
    public static let CHL_QUAD = AVChannelLayout(rawValue: AV_CH_LAYOUT_QUAD)
    public static let CHL_5POINT0 = AVChannelLayout(rawValue: AV_CH_LAYOUT_5POINT0)
    public static let CHL_5POINT1 = AVChannelLayout(rawValue: AV_CH_LAYOUT_5POINT1)
    public static let CHL_5POINT0_BACK = AVChannelLayout(rawValue: AV_CH_LAYOUT_5POINT0_BACK)
    public static let CHL_5POINT1_BACK = AVChannelLayout(rawValue: AV_CH_LAYOUT_5POINT1_BACK)
    public static let CHL_6POINT0 = AVChannelLayout(rawValue: AV_CH_LAYOUT_6POINT0)
    public static let CHL_6POINT0_FRONT = AVChannelLayout(rawValue: AV_CH_LAYOUT_6POINT0_FRONT)
    public static let CHL_HEXAGONAL = AVChannelLayout(rawValue: AV_CH_LAYOUT_HEXAGONAL)
    public static let CHL_6POINT1 = AVChannelLayout(rawValue: AV_CH_LAYOUT_6POINT1)
    public static let CHL_6POINT1_BACK = AVChannelLayout(rawValue: AV_CH_LAYOUT_6POINT1_BACK)
    public static let CHL_6POINT1_FRONT = AVChannelLayout(rawValue: AV_CH_LAYOUT_6POINT1_FRONT)
    public static let CHL_7POINT0 = AVChannelLayout(rawValue: AV_CH_LAYOUT_7POINT0)
    public static let CHL_7POINT0_FRONT = AVChannelLayout(rawValue: AV_CH_LAYOUT_7POINT0_FRONT)
    public static let CHL_7POINT1 = AVChannelLayout(rawValue: AV_CH_LAYOUT_7POINT1)
    public static let CHL_7POINT1_WIDE = AVChannelLayout(rawValue: AV_CH_LAYOUT_7POINT1_WIDE)
    public static let CHL_7POINT1_WIDE_BACK = AVChannelLayout(rawValue: AV_CH_LAYOUT_7POINT1_WIDE_BACK)
    public static let CHL_OCTAGONAL = AVChannelLayout(rawValue: AV_CH_LAYOUT_OCTAGONAL)
    public static let CHL_HEXADECAGONAL = AVChannelLayout(rawValue: AV_CH_LAYOUT_HEXADECAGONAL)
    public static let CHL_STEREO_DOWNMIX = AVChannelLayout(rawValue: AV_CH_LAYOUT_STEREO_DOWNMIX)
}
